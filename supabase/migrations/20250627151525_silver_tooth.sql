/*
  # Fix Tournament Bracket Generation for Manually Closed Tournaments

  1. Changes
    - Update the generate_tournament_bracket function to work with any number of participants (minimum 2)
    - Fix the manually_start_tournament function to properly handle tournaments with fewer than max participants
